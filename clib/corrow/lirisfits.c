...
"CFITSIO couldn't determine the total number of readouts for the ramp.\n" );
   ...
   /*-------------------------------------------------------------*/
   /* STEP 6 - Seek to firtst image extension HDU containing      */
                                     ...
                                     ImgExtData *p_img_ext_data )
{
   ...
   if (  cfitsio_naxis  != LIRIS_FILE_NAXIS )
   {
